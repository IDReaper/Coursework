...
def package():
    box1 = box(pos=(50,-36,-133), length = 20, height = 15, width = 20,color = (0,0,0))
    box2 = box(pos=(50,-40,-133), length = 25, height = 20, width = 25,color = (250,250,250))
...
def start():
    ...
    go = 1
    while go == 1:
        boxSelect = input("Which box would you like to send?(kg);(5,10,15, or any other number to end): ")
        if boxSelect == 5:
            box5kg()
            count = count + 1
            total = total + 5
...
def start_rand():
    ...
    for i in range(inBox):
        ...
        if rndBox == 0:
            ...
            time.sleep(1)
    print box_list[0:], "are the weight of the boxes that have arrived.(kg)"
